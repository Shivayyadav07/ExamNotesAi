...
const TopicForm = ({setResult,setLoading,loading,setError}) => {
  ...
  return (
    ...
    text-white
    focus:outline-none focus:ring-2 focus:ring-white/30  ' placeholder='Enter topic (e.g. Wet Development)'
    ...
    placeholder-gray-400 
    text-white
    focus:outline-none focus:ring-2 focus:ring-white/30  ' placeholder='Class / Level (e.g. Class 10)'
    ...
    value={examType}
    />
    <div className='flex flex-cols md:flex-row gap-6'>
   ...
   <div className='mt-4 space-y-2'>
    ...
    <div className='w-full h-2 rounded-full  bg-white/10 overflow-hidden'>
     ...
     transition={{ease:"easeOut",duration:0.6}}
      className='h-full bg-gradient-to-r from-green-40 via-emerald-400 to-green-500'
     >
    ...
    <div className='flex justify-between text-xs text-gray-300'>
      <span>{progessText}</span>
      <span>{progress}% </span>

    </div>
    <p className='text-xs text-gray-400 text-center'>
      This may take up 2-5 minutes. Please dont't close or refresh the page.
