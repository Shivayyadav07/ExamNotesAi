            ...
            <div className='relative'>
                ...
                cursor-pointer'>
                   ...
                   whileTap={{scale:0.97}}>
                    ...
                    <AnimatePresence> //jab exist kare jis tarah animate hua usi trah exist animate ho
                   {showCredits &&
                    <motion.div
                    ...
                    border border-white/10
                    shadow-[0_25px_60px_rgba(0,0,0,0.7)] p-4
                    text-white'>
                        ...
                        className='w-full py-2 rounded-lg  
                         bg-gradient-to-br from-white to bg-gray-200
             ...
             <div className='relative'>
                ...
                shadow-md
                cursor-pointer'>
                    <span className='text-lg'>{userData.data?.name.slice(0,1).toUpperCase() }</span>
