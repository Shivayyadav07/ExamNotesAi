...
import { setUserData } from '../redux/userSlice';
     ...
     <div className='min-h-screen overflow-hidden bg-white text-black px-8'> 
         ...
         transition={{duration:0.7}}
          >
           ...
           bg-clip-text text-transparent'>
             You get <span className='font-semibold'>100 FREE credits</span> to create exam notes, project notes, charts, graphs and 
             download clean PDFs - instantly using AI.
           </p>

           <p className='mt-4 text-sm text-gray-500'> Start with 50 free credits • Upgrade anytime for more credits 
            • Instant access 
           </p>
          </motion.div>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-8'>
              ...
              notes without paying." />
               ...
               exam-oriented notes." />
               <Feature  icon="📂" title="Project Notes" des="Well -structured documentation for
               assignments & projects." />
               <Feature  icon="📊" title="Charts & Graphs" des="Auto-generated diagrams, charts and 
               flow graphs." />
               <Feature  icon="⬇️" title="Free PDF Download " des="Download clean, printable PDFs
               instantly" />
 ...
 function Feature({icon,title,des}){
  return(
    ...
    backdrop-blur-2xl
    border border-white/10
    shadow-[0_30px_80px_rgbs(0,0,0,0.7)]
    text-white'
