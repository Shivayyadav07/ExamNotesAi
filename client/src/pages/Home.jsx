  ...
  const navigate = useNavigate()
   return (
     <div className=' min-h-screen overflow-hidden bg-white text-black'>
       ...
       {/* top */}
       <section className='max-w-7xl mx-auto pt-32 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center'>
        <div>
          <motion.div 
          ...
          style={{transformStyle:"preserve-3d"}}>
            ...
            <motion.h1 className='text-5xl lg:text-6xl font-extrabold leading-tight  bg-gradient-to-br from-black/90 via-black/60 to-black/90
            ...
            > Generate exam-focused notes, project documentation, flow diagrams and revision-ready content using AI - fatser, cleaner and smarter. </motion.p>
